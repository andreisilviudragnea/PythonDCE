...
class PyGenerateInitIntention : PyBaseIntentionAction() {
  ...
  override fun doInvoke(project: Project, editor: Editor, file: PsiFile) {
    val pyClass = PsiTreeUtil.getParentOfType(file.findElementAt(editor.caretModel.offset), PyClass::class.java,
        false) ?: return
    ...
    val initMethod = PyElementGenerator.getInstance(project).createFromText(LanguageLevel.PYTHON36,
